...
```{r}
plotwday<-ggplot(stepsperintervalwday,aes(interval,avgsteps))+geom_line()+ggtitle("Weekdays")
plotwkend<-ggplot(stepsperintervalwkend,aes(interval,avgsteps))+geom_line()+ggtitle("Weekends")
